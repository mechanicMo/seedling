...
mixin _$ChatMessage {
  ...
  List<String> get guideRefs => throw _privateConstructorUsedError;
...
abstract class $ChatMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String role, String content, List<String> guideRefs});
}
    ...
    return _then(_value.copyWith(
      ...
      content: null == content
          ...
          : content // ignore: cast_nullable_to_non_nullable
              as String,
      guideRefs: null == guideRefs
          ? _value.guideRefs
          : guideRefs // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ) as $Val);
  }
}
...
class _$ChatMessageImpl extends _ChatMessage {
  const _$ChatMessageImpl(
      ...
      final List<String> guideRefs = const []})
      : _guideRefs = guideRefs,
        super._();
  ...
  final List<String> _guideRefs;
  @override
  @JsonKey()
  List<String> get guideRefs {
    if (_guideRefs is EqualUnmodifiableListView) return _guideRefs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_guideRefs);
  }

  @override
  String toString() {
    return 'ChatMessage(role: $role, content: $content, guideRefs: $guideRefs)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._guideRefs, _guideRefs));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, role, content,
      const DeepCollectionEquality().hash(_guideRefs));
...
abstract class _ChatMessage extends ChatMessage {
  const factory _ChatMessage(
      ...
      final List<String> guideRefs}) = _$ChatMessageImpl;
...
class _$ChatSessionImpl implements _ChatSession {
  ...
  @override
  String toString() {
    return 'ChatSession(id: $id, childId: $childId, createdAt: $createdAt, messages: $messages)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, childId, createdAt,
...
abstract class _ChatSession implements ChatSession {
  const factory _ChatSession(
      ...
      final List<ChatMessage> messages}) = _$ChatSessionImpl;
